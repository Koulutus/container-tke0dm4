...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tke0dm4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tke0dm4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Koulutus/container-tke0dm4.git
cd container-tke0dm4
```
...
```
docker attach container-tke0dm4
```
